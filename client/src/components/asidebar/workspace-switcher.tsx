...
export function WorkspaceSwitcher() {
  ...
  React.useEffect(() => {
    if (!workspaceId && activeWorkspace) {
      navigate(`/workspace/${activeWorkspace._id}`, { replace: true });
    }
        ...
        <SidebarMenuItem>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <SidebarMenuButton
                size="lg"
                className="text-sidebar-foreground hover:bg-sidebar-accent data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground"
              >
                {activeWorkspace ? (
                  <>
