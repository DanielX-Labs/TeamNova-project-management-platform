        ...
        <SidebarHeader className="!py-0 bg-sidebar text-sidebar-foreground">
          <div className="flex h-[50px] items-center justify-start w-full px-1">
            <Link
              ...
              aria-label="TeamNova home"
            >
              <Logo />
              {open && <span className="hidden md:inline">TeamNova.</span>}
            </Link>
          </div>
        </SidebarHeader>
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-8 w-8 rounded-full">
                        ...
                        <AvatarFallback className="rounded-full border border-slate-600 bg-slate-800 text-slate-100">
