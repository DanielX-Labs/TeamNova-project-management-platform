              ...
              return (
                <SidebarMenuItem key={item._id}>
                  <SidebarMenuButton
                    ...
                    className="text-sidebar-foreground/75 hover:bg-sidebar-accent hover:text-sidebar-foreground data-[active=true]:bg-sidebar-primary data-[active=true]:text-sidebar-primary-foreground"
                  >
                    <Link to={projectUrl}>
                      {item.emoji}
                      <span>{item.name}</span>
